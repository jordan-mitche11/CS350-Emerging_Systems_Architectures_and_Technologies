...
class TemperatureMachine(StateMachine):
    ...
    def processTempIncButton(self):
        if(DEBUG):
            print("Set Point Increasing by 1")
    ...
    def processTempDecButton(self):
        if(DEBUG):
            print("Set Point Decreasing by 1")
    ...
    def updateLights(self):
        ...
        if (self.current_state.id == 'heat'):
            ...
            if (temp >= self.setPoint):
                # If temp is higher than setPoint red light is solid
                redLight.on()
            else:
                # If temp is below setPoint, heat turns on, red light pulses
                redLight.pulse()
        elif (self.current_state.id == 'cool'):
            # Cooling is enabled
            if (temp <= self.setPoint):
                # If temp is below setPoint, blue light is solid
                blueLight.on()
            else:
                # If temp is above setPoint, cooling turns on, blue light pulses
                blueLight.pulse()
        else:
            # Thermostat Off
            pass
    ...
    def setupSerialOutput(self):
        # Decimal formatting for higher accuracy
    ...
    def manageMyDisplay(self):
        ...
        while not self.endDisplay:
            ...
            if(altCounter < 6):
                # Shows decimal for accuracy
                lcd_line_2 = f"T:{self.getFahrenheit():0.1f}F"
    
                altCounter = altCounter + 1
            else:
                lcd_line_2 = f"Md:{tsm.current_state.id} Set:{tsm.setPoint}F"
